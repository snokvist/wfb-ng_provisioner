...
[ -z "$tx_mcs0" ] && tx_mcs0="[1,5,10]"
[ -z "$tx_mcs1" ] && tx_mcs1="[1,5,10]"
[ -z "$tx_mcs2" ] && tx_mcs2="[1,5,10]"
[ -z "$tx_mcs3" ] && tx_mcs3="[1,5,10]"
[ -z "$tx_mcs4" ] && tx_mcs4="[1,5,10]"
[ -z "$tx_mcs5" ] && tx_mcs5="[1,5,10]"
[ -z "$tx_mcs6" ] && tx_mcs6="[1,5,10]"
[ -z "$tx_mcs7" ] && tx_mcs7="[1,5,10]"
